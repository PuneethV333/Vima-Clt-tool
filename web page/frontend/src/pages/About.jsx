...
const About = () => {
  ...
  useGSAP(() => {
    ...
    targets.forEach((el) => {
      el.addEventListener("mouseenter", () => gsap.to(dot, { opacity: 0.4, duration: 0.2 }));
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-900 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-10 py-20 flex justify-center w-full">
        <div className="w-full max-w-5xl space-y-10">
          ...
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-10">
            ...
            scaffolding so you can focus on building features instead of repeating
            setup work.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-3xl bg-zinc-800/60 backdrop-blur-md p-6 md:p-8 shadow-xl">
              <h2 className="text-xl md:text-2xl font-medium mb-4 text-cyan-300">
                Why Vima?
              </h2>
