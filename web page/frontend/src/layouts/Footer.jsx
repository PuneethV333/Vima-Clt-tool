...
const Footer = () => {
  return (
    <footer className="bg-zinc-800 w-full py-12 mt-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between px-4 sm:px-6 gap-6 md:gap-8">

        
        <div className="flex flex-col justify-center space-y-3 text-center md:text-left">
          <h1 className="text-base sm:text-lg md:text-xl text-cyan-400 font-semibold">
            Created by Puneeth.V — PES University, CSE (2nd year)
          </h1>
          <h2 className="text-xs sm:text-sm italic text-zinc-400 max-w-md">
            This tool is under development and will have frequent updates in features
          </h2>
        </div>

        
        <div className="flex flex-col md:items-end space-y-2 text-slate-200 text-center md:text-right">
